Prompt 3 — Data Contract Generator (v3.1 - Compliance & DQ Edition)
...
FIELD COMPLIANCE: For EVERY field in schema, add x-compliance.

If PII: is_pii: true, sensitivity: Confidential, legal_basis: Contractual.

If not PII: is_pii: false, sensitivity: Internal.

DISTRIBUTION QUALITY (Anomaly Detection): - In the quality section, add a row_count rule.
